...
flowchart TB
    ...
    subgraph Website
        subgraph Sections
            subgraph SectionsRow1[" "]
                landing[Landing Page]:::marketing
                sec_home[Home]:::marketing
                sec_services[Services]:::marketing
                sec_location[Location]:::marketing
            end
            
            subgraph SectionsRow2[" "]
                sec_about[About]:::marketing
                sec_reviews[Reviews]:::marketing
                sec_chat[Chat]:::marketing
                sec_installer[Installer]:::marketing
            end
        end
        
        form{Form?}:::decision
        
        %% Individual section to form connections
        landing --> form
        sec_home --> form
        sec_services --> form
        sec_location --> form
    ...
    style Sections fill:#fff,stroke:#333
    %% Invisible subgraphs
    style SectionsRow1 fill:transparent,stroke:transparent
    style SectionsRow2 fill:transparent,stroke:transparent